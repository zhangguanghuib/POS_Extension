...
export default class LineDetailsCustomControl extends CartViewCustomControlBase {
    ...
    public readonly isCartLineSelecteded: Computed<boolean>;
    private readonly _cartLine: Observable<ProxyEntities.CartLine>;
    public currentQty: Observable<number>;
    public currentPrice: Observable<number>;
    public newQty: Observable<number>;
    public newPrice: Observable<number>;
    ...
    private async setCartLineQty(newQty: number): Promise<void> {
        try {
